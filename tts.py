...
from F0_MB_iSTFT_VITS import commons as commons
from F0_MB_iSTFT_VITS import utils as utils
...
class TTS:
    ...
    def inference(self, text, save_file):
        ...
        with torch.inference_mode():
            x_tst, x_tst_lengths, lang = self.get.get_text(text=text, hps=self.hps)
