...
class TextAudioCollate():
    ...
    def __call__(self, batch):
        ...
        if self.return_ids:
            return text_padded, text_lengths, spec_padded, spec_lengths, wav_padded, wav_lengths, ids_sorted_decreasing, f0_padded, lang 
        return text_padded, text_lengths, spec_padded, spec_lengths, wav_padded, wav_lengths, f0_padded, lang
