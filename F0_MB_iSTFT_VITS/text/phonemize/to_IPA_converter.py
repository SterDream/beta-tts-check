...
def US_English_converter(text):
    try:
        ...
        from English_Phonemizer import G2P_English_to_Phoneme
    phonemizer = G2P_English_to_Phoneme(default_voice="en-us")
...
def GB_English_converter(text):
    try:
        ...
        from English_Phonemizer import G2P_English_to_Phoneme
    phonemizer = G2P_English_to_Phoneme(default_voice="en-gb")
    return phonemizer(text)
...
if __name__ == "__main__":
    ...
    print("GB english: ", US_English_converter("A bottle of water."))
